      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ms-auto" defaultActiveKey="#home">
            ...
            <Nav.Item>
              <Nav.Link href="https://Nandaniblogs.vercel.app/" target="_blank" rel="noreferrer">
                <ImBlog style={{ marginBottom: "2px" }} /> Blogs
              </Nav.Link>
            </Nav.Item>

            <Nav.Item className="fork-btn">
              <Button href="https://github.com/Nandani4419/Portfolio" target="_blank" className="fork-btn-inner">
